      ...
      <main id="top">
        <section className="dashboard-grid" aria-label="Play Pulse dashboard">
          <article className="trailer-panel" id="games">
            ...
            <div className="trailer-footer"><div className="trailer-thumb"><img src="/Assets/Home Carousel 2.jpg" alt="The Blood of Dawn Walker trailer preview" /><div className="thumb-overlay"><strong>Watch trailer</strong><span>The Blood of Dawn Walker · Action / Adventure</span><div className="trailer-stats"><span><Star weight="fill" /> 4.9</span><span><Clock /> 2h 10m</span></div></div><Play className="thumb-play" weight="fill" /></div><a href="#games" aria-label="Next trailer"><ArrowRight /></a></div>
          </article>
