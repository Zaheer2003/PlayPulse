      ...
      <main id="top">
        <section className="dashboard-grid" aria-label="Play Pulse dashboard">
          ...
          <div className="dashboard-side">
            <section className="hub-panel" id="community" aria-labelledby="hub-title"><div className="panel-heading compact"><div><h2 id="hub-title">Community hub</h2></div><a className="show-more" href="#community">Show more <ArrowRight /></a></div><div className="profile-row"><div className="profile-card"><img src="/Assets/Ellipse 27.png" alt="Maya profile" /><div className="profile-info"><strong>Maya</strong><span>Played games</span></div><button className="live-button" type="button"><span />Live</button></div><div className="profile-card"><img src="/Assets/Ellipse 27-1.png" alt="Jordan profile" /><div className="profile-info"><strong>Jordan</strong><span>Played games</span></div><button className="live-button" type="button"><span />Live</button></div><div className="profile-card"><img src="/Assets/Ellipse 27-2.png" alt="Kai profile" /><div className="profile-info"><strong>Kai</strong><span>Played games</span></div><button className="live-button" type="button"><span />Live</button></div></div></section>
