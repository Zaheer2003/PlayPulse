      ...
      <main id="top">
        <section className="dashboard-grid" aria-label="Play Pulse dashboard">
          <article className="trailer-panel" id="games">
            <div className="trailer-art"><img src="/Assets/Home Carousel 1.jpg" alt="The Blood of Dawn Walker trailer artwork" /><div className="trailer-overlay"><span className="trailer-kicker">#Trending</span><h2>The Blood of <em>Dawn Walker</em></h2><p>Enter a dark, mythic adventure and fight your way through a world shaped by ancient power.</p><div className="trailer-actions"><button className="play-now-button" type="button"><Play weight="fill" /> Play now</button><button className="save-trailer-button" type="button" aria-label="Save The Blood of Dawn Walker" title="Save trailer"><BookmarkSimple weight="regular" /></button></div></div><div className="trailer-bottom-meta"><div className="watch-preview"><img src="/Assets/Home Carousel 2.jpg" alt="Trailer preview" /><span>Watch trailer</span><Play weight="fill" /></div><div className="trailer-stats"><span className="rating-stat"><Star weight="fill" /> 4.8/5</span><span className="watch-stat"><Clock /> 2h 10m</span></div></div><div className="carousel-controls"><div className="carousel-dots" aria-label="Carousel slide position"><span className="active" /><span /><span /></div></div></div>
          </article>

          <div className="dashboard-side">
            <section className="hub-panel" id="community" aria-labelledby="hub-title"><div className="panel-heading compact"><div><h2 id="hub-title">Community hub</h2></div><a className="show-more" href="#community">Show more <ArrowRight /></a></div><div className="profile-row"><div className="profile-card"><img src="/Assets/Ellipse 27.png" alt="Maya profile" /><div className="profile-info"><strong>Maya</strong><span>The Blood of Dawn Walker</span></div><button className="live-button" type="button"><span />Live</button></div><div className="profile-card"><img src="/Assets/Ellipse 27-1.png" alt="Jordan profile" /><div className="profile-info"><strong>Jordan</strong><span>Hades II</span></div><button className="live-button" type="button"><span />Live</button></div><div className="profile-card"><img src="/Assets/Ellipse 27-2.png" alt="Kai profile" /><div className="profile-info"><strong>Kai</strong><span>Split Fiction</span></div><button className="live-button" type="button"><span />Live</button></div></div></section>
