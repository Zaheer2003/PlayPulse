      ...
      <main id="top">
        <section className="dashboard-grid" aria-label="Play Pulse dashboard">
          ...
          <div className="dashboard-side">
            ...
            <section className="channels-panel" id="playlists" aria-labelledby="channels-title"><div className="panel-heading compact"><div><h2 id="channels-title">Discover channels</h2></div></div><div className="channel-row"><a className="channel-card" href="#strategy"><img src="/Assets/Indie Spotlight 1.png" alt="Indie spotlight channel" /><div className="channel-info"><span>Indie spotlight</span><small>24 games</small></div><button className="join-button" type="button">Join</button></a><a className="channel-card" href="#multiplayer"><img src="/Assets/Indie Spotlight 2.png" alt="Multiplayer channel" /><div className="channel-info"><span>Late-night co-op</span><small>18 games</small></div><button className="join-button" type="button">Join</button></a></div><a className="show-more channel-show-more" href="#playlists">Show more <ArrowRight /></a></section>
          </div>
        </section>
      </main>
      <Footer />
